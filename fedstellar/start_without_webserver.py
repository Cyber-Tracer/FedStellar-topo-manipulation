...
import math
import logging
from fedstellar.learning.aggregators.voyager import Voyager
...
def create_particiants_configs(basic_config, example_node_config_path=example_node_config_path, start_port=45000):
    ...
    for node in node_range:
        ...
        participant_config["aggregator_args"]["sentinel_distance_threshold"] = basic_config["sentinel_distance_threshold"]
